...
import { StatsWordResultListResultsInner } from './stats-word-result-list-results-inner';
 ...
 * @export
 * @interface StatsWordResultList
 */
export interface StatsWordResultList {
    /**
     * Additional Information provided by OUP
     * @type {object}
     * @memberof StatsWordResultList
     */
    'metadata'?: object;
    /**
     * A list of found words along with their frequencies
     * @type {Array<StatsWordResultListResultsInner>}
     * @memberof StatsWordResultList
     */
    'results'?: Array<StatsWordResultListResultsInner>;
}
