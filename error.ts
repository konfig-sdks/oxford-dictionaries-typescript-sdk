...
/**
 * This class provides a wrapper for network errors when making requests to Oxford Dictionaries
 */
export class OxfordDictionariesError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "OxfordDictionariesError";
